 ...
 *
 * @author Lucy  Enyi, Junnias Mulimbi
 * @version 1.0
 */
public class SearchActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String sharedPrefsString = sharedPrefs.getString("Country", "");
        ...
        //EditText values
        EditText inputStartDate = findViewById(R.id.StartDate_id);
        EditText inputEndDate = findViewById(R.id.inputEndDate);
        inputCountry.setText(sharedPrefsString);
